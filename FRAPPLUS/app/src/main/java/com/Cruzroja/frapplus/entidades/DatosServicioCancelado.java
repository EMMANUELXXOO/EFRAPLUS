...
public class DatosServicioCancelado {
    ...
    public String getHoraHospital() {
        return HoraHospital;
    }

    public void setHoraHospital(String horaHospital) {

...
public class ServicioReporte extends AppCompatActivity {
...
/////////////////////////////////////////////////////////////////////////
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_servicio_reporte);
        ...
        btnHoraLlamada.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(
                        ...
                        DateFormat.is24HourFormat(ServicioReporte.this) // Formato de 24 horas
                );
    ...
    ///////////////////////////////////////////////
        ...
        final DBFRAPOrdenControl dbfrapOrdenControl = new DBFRAPOrdenControl(ServicioReporte.this);
        ...
        btnregresar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ServicioReporte.this, MainReporte.class);
...
//              Realizar validaciones
                if (fecha.isEmpty() || horaLlamada.isEmpty() || motivoAtencion.isEmpty()) {
                    ...
                    Toast.makeText(ServicioReporte.this, "Por favor, complete todos los campos ", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DBFRAPOrdenControl dbfrapOrden1 = new DBFRAPOrdenControl(ServicioReporte.this);
                    long ID = dbfrapOrden1.insertaServicio1Reporte(claveGenerada,fecha,dia,horaLlamada,horaSalida,horaLlegada,horaTraslado,horaHospital,horaDisponible,selectedMotivo,selectedSubmotivo);
                    if (ID > 0) {
                        Toast.makeText(ServicioReporte.this, "Dato Guardado", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(ServicioReporte.this, ServicioReporte2.class);
                        intent.putExtra("id", id);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
                        finish();
                        ...
                        correcto = dbfrapOrden1.editarServicio1Reporte(claveGenerada,fecha,dia,horaLlamada,horaSalida,horaLlegada,horaTraslado,horaHospital,horaDisponible,selectedMotivo,selectedSubmotivo);
                        if (correcto) {
                            Intent intent = new Intent(ServicioReporte.this, ServicioReporte2.class);
                            intent.putExtra("id", id);
                            startActivity(intent);
                            ...
                            // String mensaje = "Clave: " + claveGenerada +"Estado: " + selectedEstado + "\nDelegación: " + selectedDelegacion + "\nAsignación: " + selectedAsignacion;
                            //Toast.makeText(ServicioReporte.this, mensaje, Toast.LENGTH_SHORT).show();
                            Toast.makeText(ServicioReporte.this, "Datos Modificados", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(ServicioReporte.this, "Error en la modificación", Toast.LENGTH_SHORT).show();
                        }
                        Toast.makeText(ServicioReporte.this, "Datos Modificados", Toast.LENGTH_SHORT).show();
                    }
                }
